...
dir = 'images/'
filename = 'pbimage_12:18:55.658389529_p.fits'
print "Reading image..."
...
os.system('avconv -r 30 -i imagestovid/img%03d.png -b:v 1000k -c:v libx264 olivid_2.mp4') #30 fps. %03d means 3 digit numerical extension of filenames
